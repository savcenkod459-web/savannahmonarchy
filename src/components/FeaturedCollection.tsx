                    ...
                    <div className="pt-4 md:pt-6">
                      ...
                      <div className="flex gap-2 mt-6 md:mt-8">
                        ...
                        <Button 
                          ...
                          className="flex-1 bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_25px_rgba(217,179,112,0.7)] hover:-translate-y-1 transition-all duration-300"
                        >
                          {t('catCard.book')}
                        </Button>
                      </div>
