...
export const CatDetailModal = ({ images, video, isOpen, onClose }: CatDetailModalProps) => {
        ...
        <DialogContent className="max-w-[90vw] max-h-[90vh] p-0 bg-background border-primary/20">
          <div className="relative w-full h-[90vh] flex">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="absolute top-4 right-4 z-50 text-foreground hover:bg-primary/20 rounded-full"
              onClick={onClose}
            >
              <X className="h-6 w-6" />
            </Button>
                  ...
                  {images.length > 1 && (
                    <>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="absolute left-2 top-1/2 -translate-y-1/2 text-foreground hover:bg-primary/20 rounded-full"
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        className="absolute right-2 top-1/2 -translate-y-1/2 text-foreground hover:bg-primary/20 rounded-full"
