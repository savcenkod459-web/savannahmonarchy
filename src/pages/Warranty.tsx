            ...
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                ...
                <div className="group p-6 glass-card rounded-2xl shadow-glow border border-primary/20 hover:border-primary/40 transition-all duration-300 hover-lift">
                  ...
                  <button onClick={copyEmail} className="text-primary font-semibold text-lg hover:text-primary/80 transition-colors cursor-pointer">savannahmonarchy@gmail.com</button>
                </div>
              </div>
            </div>
          </div>
