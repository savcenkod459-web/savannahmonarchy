      ...
      <main className="pt-24">
        ...
        <section className="py-20 bg-secondary/30 relative overflow-hidden">
          ...
          <div className="absolute bottom-20 right-10 opacity-5">
            <Trophy className="w-40 h-40 text-accent animate-float" style={{animationDelay: '2s'}} />
          </div>
        ...
        <section className="py-20 bg-secondary/30 relative overflow-hidden">
          <div className="absolute inset-0 opacity-5">
            ...
            <Diamond className="absolute bottom-1/4 right-1/4 w-20 h-20 text-accent animate-pulse" style={{animationDelay: '1.5s'}} />
          </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="group p-8 glass-card rounded-3xl shadow-soft hover:shadow-glow transition-all duration-500 hover-lift animate-scale-in micro-interaction"
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4 animate-fade-in" style={{ animationDelay: "200ms" }}>
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      <div className="mt-1.5 h-1.5 w-1.5 rounded-full bg-primary flex-shrink-0" />
                      <span>Документированные родословные минимум 5 поколений</span>
                    </li>
                  </ul>
                </div>
