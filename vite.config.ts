...
export default defineConfig(({ mode }) => ({
  ...
  resolve: {
    ...
    dedupe: ['react', 'react-dom', 'react-i18next', 'i18next', 'next-themes', 'react-router-dom', '@tanstack/react-query'],
  },
  optimizeDeps: {
    include: ['react', 'react-dom', 'react-i18next', 'i18next', 'next-themes', 'react-router-dom', '@tanstack/react-query', 'sonner'],
    force: true,
    esbuildOptions: {
